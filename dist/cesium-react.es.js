import { Camera, CesiumWidget, Entity, EntityCollection, PointPrimitiveCollection, Primitive, PrimitiveCollection, Scene, Viewer } from 'cesium';
...
function (_CesiumComponent) {
  ...
  _proto.createCesiumElement = function createCesiumElement(options) {
    if (this.element) {
      return new Viewer(this.element, options);
    }
...
export { types as PropTypes, Entity$1 as Entity, PointPrimitive, PointPrimitiveCollection$1 as PointPrimitiveCollection, Primitive$1 as Primitive, Viewer$1 as Viewer };

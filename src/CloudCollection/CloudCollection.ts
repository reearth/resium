...
export type CloudCollectionCesiumProps = PickCesiumProps<
  CesiumCloudCollection,
  typeof cesiumProps
>;
...
export type CloudCollectionProps = CloudCollectionCesiumProps &
...
const CloudCollection = createCesiumComponent<
  CesiumCloudCollection,

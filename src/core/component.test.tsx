...
describe('core/component', () => {
  ...
  it('should render container', async () => {
    ...
    await waitFor(() => {
      expect(createFn).toBeCalledWith(expect.anything(), expect.anything(), expect.any(HTMLDivElement))
  ...
  it('should keep state', () => {
    ...
    waitFor(() => {
      expect(provideFn).toBeCalledWith(expect.anything(), expect.anything(), expect.anything(), state)

...
export type StaticMethodOptions<T extends { [J in K]: (...args: any[]) => any }, K extends keyof T> = NonNullable<
  Parameters<T[K]>[0]
>

export type StaticMethodOptions2<T extends { [J in K]: (...args: any[]) => any }, K extends keyof T> = NonNullable<
  Parameters<T[K]>[1]
>
...
export type UnusedCesiumProps<T, K, E extends { [e: string]: string } = {}, I extends string = never> = Exclude<
  InvalidProps<CesiumPureProps<T>, ArrayKeys<keyof K>, E>,
  I
>

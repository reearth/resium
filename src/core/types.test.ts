...
import { ConstructorOptions, UnusedCesiumProps, PickCesiumProps, Merge, UnionMerge, ArrayKeys } from './types'
...
expectType<TypeEqual<ArrayKeys<[1, 2] | 1 | ['hoge'] | 'foo' | undefined | null>, 'hoge' | 'foo'>>(true)
expectType<TypeOf<Merge<{ a: string; b?: string }, { b: number; c?: boolean }>, { a: string; b: number; c?: boolean }>>(
  true,
)
expectType<
  TypeOf<
...
expectType<TypeOf<PickCesiumProps<Merge<Test, TestOptions>, 'hoge'>, { hoge?: string | number }>>(true)
expectType<TypeOf<PickCesiumProps<UnionMerge<Test, TestOptions>, 'hoge'>, { hoge?: string | number | null }>>(true)

...
import { createCesiumComponent, EventkeyMap, PickCesiumProps, ConstructorOptions, Merge, EventProps } from '../core'
...
export type Target = Merge<CesiumTimeDynamicPointCloud, ConstructorOptions<typeof CesiumTimeDynamicPointCloud>>

export type TimeDynamicPointCloudCesiumProps = PickCesiumProps<Target, typeof cesiumProps, 'intervals'>

export type TimeDynamicPointCloudCesiumReadonlyProps = PickCesiumProps<Target, typeof cesiumReadonlyProps>
...
export const cesiumEventProps: EventkeyMap<CesiumTimeDynamicPointCloud, TimeDynamicPointCloudCesiumEvents> = {
  onFrameChange: 'frameChanged',
}

const TimeDynamicPointCloud = createCesiumComponent<CesiumTimeDynamicPointCloud, TimeDynamicPointCloudProps>({
  name: 'TimeDynamicPointCloud',
  create(context, props) {
    if (!context.cesiumWidget || !context.primitiveCollection || !context.cesiumWidget?.clock) return

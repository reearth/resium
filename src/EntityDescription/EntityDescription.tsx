...
const EntityDescription: FC<EntityDescriptionProps> = ({ children, container, resizeInfoBox = true }) => {
    ...
    if (selected) {
      ...
      if (resizeInfoBox) {
        ...
        interval = window.setInterval(() => {
          ...
          const node = viewer.infoBox.container.querySelector('.cesium-infoBox.cesium-infoBox-visible')

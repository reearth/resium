import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-B_0iYUWB.js";import{t as r}from"./jsx-runtime-DXFqSddf.js";import{n as i,r as a,t as o}from"./core-CJ9frRFN.js";import{t as s}from"./Viewer-vipVb3FM.js";import{t as c}from"./Viewer-CpgZ-RsP.js";import{n as l,t as u}from"./Cesium3DTileset-X5OcPlPG.js";var d=t((()=>{l()})),f,p=t((()=>{o(),f=i({name:`Fxaa`,create:(e,t)=>t.fxaa,props:[]})})),m,h,g,_=t((()=>{o(),m=[`enabled`,`selected`],h=[`clearColor`,`forcePowerOfTwo`,`fragmentShader`,`name`,`pixelDatatype`,`pixelFormat`,`sampleMode`,`scissorRectangle`,`textureScale`,`uniforms`],g=a({name:`PostProcessStage`,create(e,t){if(!e.scene)return;let n=new Cesium.PostProcessStage(t);return typeof t.enabled==`boolean`&&(n.enabled=t.enabled),t.selected&&(n.selected=t.selected),e.scene.postProcessStages.add(n),n},destroy(e,t){t.scene&&!t.scene.isDestroyed()&&t.scene.postProcessStages.remove(e),e.isDestroyed()||e.destroy()},cesiumProps:m,cesiumReadonlyProps:h})})),v,y=t((()=>{o(),v=i({name:`BlackAndWhiteStage`,props:[`gradations`],create:()=>Cesium.PostProcessStageLibrary.createBlackAndWhiteStage()})})),b,x=t((()=>{o(),b=i({name:`LensFlareStage`,props:[`dirtTexture`,`starTexture`,`intensity`,`distortion`,`ghostDispersal`,`haloWidth`,`earthRadius`],create:()=>Cesium.PostProcessStageLibrary.createLensFlareStage()})})),S,C=t((()=>{o(),S=i({name:`NightVisionStage`,props:[],create:()=>Cesium.PostProcessStageLibrary.createNightVisionStage()})})),w=t((()=>{_(),y(),x(),p(),C()})),T,E,D,O,k,A,j,M,N,P;t((()=>{T=e(n(),1),d(),c(),p(),w(),E=r(),D={title:`PostProcessStage`,component:g},O=`

import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{n,t as r}from"./iframe-C5z0sm_V.js";import{n as i,t as a}from"./VrtViewer-DmiH-xWB.js";import{n as o,t as s}from"./KmlDataSource-DF4klqHI.js";var c,l,u,d,f,p;e((()=>{c=t(n(),1),i(),o(),l=r(),u={title:`VRT/KmlDataSource`,tags:[`vrt`],parameters:{layout:`fullscreen`,docs:{description:{component:"Stories tagged `vrt` are rendered deterministically (see `src/__vrt__`) so the\ntest runner can compare screenshots. Run `npm run storybook:build:vrt` then `npm run vrt`."}}}},d=URL.createObjectURL(new Blob([`<?xml version="1.0" encoding="UTF-8"?>

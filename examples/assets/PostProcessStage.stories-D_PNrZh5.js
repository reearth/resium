import{i as e,s as t}from"./preload-helper-xPQekRTU.js";import{n,t as r}from"./iframe-Co89mBoI.js";import{i,o as a,t as o}from"./core-BxKpaXN9.js";import{t as s}from"./Viewer-DhNArJQ_.js";import{t as c}from"./Viewer-akLBly8J.js";import{n as l,t as u}from"./Cesium3DTileset-BG2mcfvK.js";var d=e((()=>{l()})),f,p=e((()=>{o(),f=i({name:`Fxaa`,create:(e,t)=>t.fxaa,props:[]})})),m,h,g,_=e((()=>{o(),m=[`enabled`,`selected`],h=[`clearColor`,`forcePowerOfTwo`,`fragmentShader`,`name`,`pixelDatatype`,`pixelFormat`,`sampleMode`,`scissorRectangle`,`textureScale`,`uniforms`],g=a({name:`PostProcessStage`,create(e,t){if(!e.scene)return;let n=new Cesium.PostProcessStage(t);return typeof t.enabled==`boolean`&&(n.enabled=t.enabled),t.selected&&(n.selected=t.selected),e.scene.postProcessStages.add(n),n},destroy(e,t){t.scene&&!t.scene.isDestroyed()&&t.scene.postProcessStages.remove(e),e.isDestroyed()||e.destroy()},cesiumProps:m,cesiumReadonlyProps:h})})),v,y=e((()=>{o(),v=i({name:`BlackAndWhiteStage`,props:[`gradations`],create:()=>Cesium.PostProcessStageLibrary.createBlackAndWhiteStage()})})),b,x=e((()=>{o(),b=i({name:`LensFlareStage`,props:[`dirtTexture`,`starTexture`,`intensity`,`distortion`,`ghostDispersal`,`haloWidth`,`earthRadius`],create:()=>Cesium.PostProcessStageLibrary.createLensFlareStage()})})),S,C=e((()=>{o(),S=i({name:`NightVisionStage`,props:[],create:()=>Cesium.PostProcessStageLibrary.createNightVisionStage()})})),w=e((()=>{_(),y(),x(),p(),C()})),T,E,D,O,k,A,j,M,N,P;e((()=>{T=t(n(),1),d(),c(),p(),w(),E=r(),D={title:`PostProcessStage`,component:g},O=`

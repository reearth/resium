import{j as t}from"./jsx-runtime-BjG_zV1W.js";import{a as Q}from"./index-CjDrOnrV.js";import{r as l}from"./index-yIsmwZOr.js";import{e as pe}from"./storybook-lrzrXzR7.js";import{E as s}from"./Entity-6JEZeUU-.js";import{V as h}from"./Viewer-fvH1XzmE.js";import{r as me}from"./index-CZ_84MJS.js";import{c as a,u as he}from"./component-P3MpLVno.js";import"./v4-Dz_GI0CC.js";const de=["image","show","scale","horizontalOrigin","verticalOrigin","eyeOffset","pixelOffset","rotation","alignedAxis","width","height","color","scaleByDistance","translucencyByDistance","pixelOffsetScaleByDistance","imageSubRegion","sizeInMeters","heightReference","distanceDisplayCondition","disableDepthTestDistance","splitDirection"],ue={onDefinitionChange:"definitionChanged"},Ce=a({name:"BillboardGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.BillboardGraphics(i);return e.entity.billboard=r,r},destroy(e,i){i.entity&&(i.entity.billboard=void 0)},cesiumProps:de,cesiumEventProps:ue}),Z=Ce,ye=["heightReference","dimensions","show","fill","material","outline","outlineColor","outlineWidth","shadows","distanceDisplayCondition"],ge={onDefinitionChange:"definitionChanged"},fe=a({name:"BoxGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.BoxGraphics(i);return e.entity.box=r,r},destroy(e,i){i.entity&&(i.entity.box=void 0)},cesiumProps:ye,cesiumEventProps:ge}),q=fe,Ee=["positions","width","cornerType","height","heightReference","extrudedHeight","extrudedHeightReference","show","fill","material","outline","outlineColor","outlineWidth","granularity","shadows","distanceDisplayCondition","zIndex","classificationType"],Ge={onDefinitionChange:"definitionChanged"},De=a({name:"CorridorGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.CorridorGraphics(i);return i.classificationType&&(r.classificationType=i.classificationType),e.entity.corridor=r,r},destroy(e,i){i.entity&&(i.entity.corridor=void 0)},cesiumProps:Ee,cesiumEventProps:Ge}),J=De,xe=["heightReference","length","topRadius","bottomRadius","show","fill","material","outline","outlineColor","outlineWidth","numberOfVerticalLines","slices","distanceDisplayCondition","shadows"],Pe={onDefinitionChange:"definitionChanged"},we=a({name:"CylinderGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.CylinderGraphics(i);return e.entity.cylinder=r,r},destroy(e,i){i.entity&&(i.entity.cylinder=void 0)},cesiumProps:xe,cesiumEventProps:Pe}),X=we,Le=["semiMajorAxis","semiMinorAxis","height","heightReference","extrudedHeight","show","fill","material","outline","outlineColor","outlineWidth","numberOfVerticalLines","rotation","stRotation","granularity","shadows","distanceDisplayCondition","zIndex","classificationType","extrudedHeightReference"],Re={onDefinitionChange:"definitionChanged"},be=a({name:"EllipseGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.EllipseGraphics(i);return e.entity.ellipse=r,r},destroy(e,i){i.entity&&(i.entity.ellipse=void 0)},cesiumProps:Le,cesiumEventProps:Re}),ee=be,je=["heightReference","radii","show","fill","innerRadii","material","maximumClock","maximumCone","minimumClock","minimumCone","outline","outlineColor","outlineWidth","subdivisions","stackPartitions","slicePartitions","shadows","distanceDisplayCondition"],Be={onDefinitionChange:"definitionChanged"},Ae=a({name:"EllipsoidGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.EllipsoidGraphics(i);return e.entity.ellipsoid=r,r},destroy(e,i){i.entity&&(i.entity.ellipsoid=void 0)},cesiumProps:je,cesiumEventProps:Be}),ie=Ae,ve=({children:e,container:i,resizeInfoBox:r=!0})=>{const{viewer:n,entity:d}=he(),[m,C]=l.useState(!1),c=l.useMemo(()=>{var o;return i??((o=n==null?void 0:n.infoBox.frame.contentDocument)==null?void 0:o.createElement("div"))},[i,n==null?void 0:n.infoBox.frame.contentDocument]);return l.useEffect(()=>{if(!n||!d)return;const o=p=>{C(!!p&&p.id===d.id)};return n.selectedEntityChanged.addEventListener(o),()=>{n.selectedEntityChanged.removeEventListener(o)}},[d,n]),l.useEffect(()=>{var P,w;if(i||!c||!n)return;const o=(P=n.infoBox)==null?void 0:P.frame,p=(w=o==null?void 0:o.contentDocument)==null?void 0:w.querySelector(".cesium-infoBox-description");if(!o||!p)return;let u;if(m){if(r){const ce=p.getBoundingClientRect().height;o.style.height=ce+"px",u=window.setInterval(()=>{const L=n.infoBox.container.querySelector(".cesium-infoBox.cesium-infoBox-visible");L&&(clearInterval(u),u=void 0,p.appendChild(c),L.classList.remove("cesium-infoBox-bodyless"),o.style.height=p.getBoundingClientRect().height+"px")},10)}}else c.parentElement===p&&p.removeChild(c);return u?()=>clearTimeout(u):void 0},[c,i,r,m,n]),c?t.jsx(t.Fragment,{children:me.createPortal(t.jsx(t.Fragment,{children:!i||m?e:null}),c)}):null},R=ve,Se=["text","font","style","fillColor","outlineColor","outlineWidth","show","showBackground","backgroundColor","backgroundPadding","scale","horizontalOrigin","verticalOrigin","eyeOffset","pixelOffset","translucencyByDistance","pixelOffsetScaleByDistance","scaleByDistance","heightReference","distanceDisplayCondition","disableDepthTestDistance"],Te={onDefinitionChange:"definitionChanged"},Me=a({name:"LabelGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.LabelGraphics(i);return e.entity.label=r,r},destroy(e,i){i.entity&&(i.entity.label=void 0)},cesiumProps:Se,cesiumEventProps:Te}),te=Me,He=["uri","show","scale","minimumPixelSize","maximumScale","incrementallyLoadTextures","runAnimations","clampAnimations","nodeTransformations","shadows","heightReference","distanceDisplayCondition","silhouetteColor","silhouetteSize","color","colorBlendMode","colorBlendAmount","clippingPlanes","imageBasedLightingFactor","lightColor","articulations","customShader","enableVerticalExaggeration","environmentMapOptions"],Oe={onDefinitionChange:"definitionChanged"},Ne=a({name:"ModelGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.ModelGraphics(i);return e.entity.model=r,r},destroy(e,i){i.entity&&(i.entity.model=void 0)},cesiumProps:He,cesiumEventProps:Oe}),re=Ne,$e=["leadTime","trailTime","show","width","material","resolution","distanceDisplayCondition"],Ie={onDefinitionChange:"definitionChanged"},We=a({name:"PathGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.PathGraphics(i);return e.entity.path=r,r},destroy(e,i){i.entity&&(i.entity.path=void 0)},cesiumProps:$e,cesiumEventProps:Ie}),se=We,Ve=["plane","dimensions","show","fill","material","outline","outlineColor","outlineWidth","shadows","distanceDisplayCondition"],_e={onDefinitionChange:"definitionChanged"},ze=a({name:"PlaneGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.PlaneGraphics(i);return e.entity.plane=r,r},destroy(e,i){i.entity&&(i.entity.plane=void 0)},cesiumProps:Ve,cesiumEventProps:_e}),ne=ze,Ue=["color","pixelSize","outlineColor","outlineWidth","show","scaleByDistance","translucencyByDistance","heightReference","distanceDisplayCondition","disableDepthTestDistance","splitDirection"],Ke={onDefinitionChange:"definitionChanged"},Ye=a({name:"PointGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.PointGraphics(i);return e.entity.point=r,r},destroy(e,i){i.entity&&(i.entity.point=void 0)},cesiumProps:Ue,cesiumEventProps:Ke}),oe=Ye,ke=["arcType","hierarchy","height","heightReference","extrudedHeight","extrudedHeightReference","show","fill","material","outline","outlineColor","outlineWidth","stRotation","granularity","perPositionHeight","closeTop","closeBottom","shadows","distanceDisplayCondition","zIndex","classificationType","textureCoordinates"],Fe={onDefinitionChange:"definitionChanged"},Qe=a({name:"PolygonGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.PolygonGraphics(i);return e.entity.polygon=r,r},destroy(e,i){i.entity&&(i.entity.polygon=void 0)},cesiumProps:ke,cesiumEventProps:Fe}),ae=Qe,Ze=["arcType","classificationType","positions","clampToGround","width","show","material","depthFailMaterial","granularity","shadows","distanceDisplayCondition","zIndex"],qe={onDefinitionChange:"definitionChanged"},Je=a({name:"PolylineGraphics",create(e,i){if(!e.entity)return;const r=new Cesium.PolylineGraphics(i);return e.entity.polyline=r,r},destroy(e,i){i.entity&&(i.entity.polyline=void 0)},cesiumProps:Ze,cesiumEventProps:qe}),le=Je,pi={title:"Entity",component:s},b=()=>{const e=document.createElement("canvas");return e.width=100,e.height=100,e},Xe=(e,i)=>{const r=e.getContext("2d");r&&(r.clearRect(0,0,e.width,e.height),r.fillStyle="rgba(100,0,0,0.8)",r.beginPath(),r.arc(e.width/2,e.height/2,i*e.width/2,0,Math.PI*2,!1),r.fill())},ei=e=>{const i=l.useMemo(b,[]),r=l.useMemo(b,[]),[n,d]=l.useState(),m=l.useRef(0);return l.useEffect(()=>{const C=window.setInterval(()=>{m.current=Math.min(m.current+.01,1),d(c=>{const o=c===i?r:i;return o&&Xe(o,m.current),o}),m.current>=1&&clearInterval(C)},10);return()=>window.clearInterval(C)},[i,r]),t.jsx(s,{...e,billboard:{image:n}})},y={render:e=>t.jsx(h,{full:!0,children:t.jsx(s,{...e,name:"test",description:"test!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),point:{pixelSize:10}})})},g={render:e=>{const[i,r]=l.useState(0);return t.jsxs(h,{full:!0,children:[t.jsx(s,{...e,name:"test1",position:Cesium.Cartesian3.fromDegrees(-74,40,100),point:{pixelSize:15,color:Cesium.Color.YELLOW},description:"Normal Description"}),t.jsx(s,{...e,name:"test3",position:Cesium.Cartesian3.fromDegrees(-74,30,100),point:{pixelSize:15,color:Cesium.Color.RED},children:t.jsx(R,{children:t.jsx("h1",{children:"Hello!"})})}),t.jsx(s,{...e,name:"test4",position:Cesium.Cartesian3.fromDegrees(-74,20,100),point:{pixelSize:15,color:Cesium.Color.ORANGE},children:t.jsxs(R,{children:[t.jsx("h1",{children:"Hello!"}),t.jsx("p",{children:"This is description. It can be described with React!"}),t.jsxs("button",{onClick:()=>r(n=>n+1),children:["counter: ",i]})]})})]})}},f={render:e=>t.jsx(h,{full:!0,children:t.jsx(s,{...e,name:"test",description:"test!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),point:{pixelSize:10},selected:!0,tracked:!0})})},E={render:()=>t.jsx(h,{full:!0,children:t.jsx(ei,{name:"test",description:"test",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100)})})},G={render:e=>t.jsx(h,{full:!0,children:t.jsx(s,{...e,name:"test",description:"test!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),point:{pixelSize:10},...pe})})},D={render:e=>t.jsxs(h,{full:!0,onMouseEnter:Q("mouseenter"),children:[t.jsx(s,{...e,name:"BillboardGraphics",description:"BillboardGraphics!!",position:Cesium.Cartesian3.fromDegrees(-40.0707383,40.7117244,100),selected:!0,children:t.jsx(Z,{image:"example.png",scale:.05})}),t.jsx(s,{...e,name:"BoxGraphics",description:"BoxGraphics!!",position:Cesium.Cartesian3.fromDegrees(.0707383,40.7117244,100),children:t.jsx(q,{material:Cesium.Color.RED,dimensions:new Cesium.Cartesian3(4e5,3e5,5e5)})}),t.jsx(s,{...e,name:"CorridorGraphics",description:"CorridorGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(J,{material:Cesium.Color.YELLOW,positions:Cesium.Cartesian3.fromDegreesArray([-100,40,-105,40,-105,35]),height:2e5,extrudedHeight:1e5,width:2e5,cornerType:Cesium.CornerType.BEVELED,outline:!0,outlineColor:Cesium.Color.WHITE})}),t.jsx(s,{...e,name:"CylinderGraphics",description:"CylinderGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,20.7117244,100),children:t.jsx(X,{length:4e5,topRadius:2e5,bottomRadius:2e5,material:Cesium.Color.GREEN.withAlpha(.5),outline:!0,outlineColor:Cesium.Color.DARKGREEN})}),t.jsx(s,{...e,name:"EllipseGraphics",description:"EllipseGraphics!!",position:Cesium.Cartesian3.fromDegrees(-34.0707383,60.7117244,100),children:t.jsx(ee,{material:Cesium.Color.RED,semiMinorAxis:15e4,semiMajorAxis:3e5,extrudedHeight:2e5,rotation:.78539,outline:!0})}),t.jsx(s,{...e,name:"EllipsoidGraphics",description:"EllipsoidGraphics!!",position:Cesium.Cartesian3.fromDegrees(-14.0707383,.7117244,100),children:t.jsx(ie,{material:Cesium.Color.BLUEVIOLET,radii:new Cesium.Cartesian3(3e5,3e5,3e5),fill:!0,outline:!0,outlineColor:new Cesium.Color(0,0,0,1)})}),t.jsx(s,{...e,name:"LabelGraphics",description:"LabelGraphics!!",position:Cesium.Cartesian3.fromDegrees(-34.0707383,5.7117244,100),children:t.jsx(te,{text:"LabelGraphics",font:"24px Helvetica",fillColor:Cesium.Color.SKYBLUE,outlineColor:Cesium.Color.BLACK,outlineWidth:2,style:Cesium.LabelStyle.FILL_AND_OUTLINE})}),t.jsx(s,{...e,name:"ModelGraphics",description:"ModelGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(re,{uri:"Cesium_Air.glb",minimumPixelSize:128,maximumScale:2e4})}),t.jsx(s,{...e,name:"PathGraphics",description:"PathGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(se,{material:Cesium.Color.RED,width:8,leadTime:10,trailTime:1e3,resolution:5})}),t.jsx(s,{...e,name:"PlaneGraphics",description:"PlaneGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,50.7117244,100),children:t.jsx(ne,{plane:new Cesium.Plane(Cesium.Cartesian3.UNIT_Z,0),dimensions:new Cesium.Cartesian2(4e5,3e5),fill:!1,outline:!0,outlineColor:Cesium.Color.YELLOW})}),t.jsx(s,{...e,name:"PointGraphics",description:"PointGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,60.7117244,100),children:t.jsx(oe,{color:Cesium.Color.BISQUE,pixelSize:10})}),t.jsx(s,{...e,name:"PolygonGraphics",description:"PolygonGraphics!!",children:t.jsx(ae,{hierarchy:Cesium.Cartesian3.fromDegreesArray([-108,42,-100,42,-104,40]),material:Cesium.Color.GREEN})}),t.jsx(s,{...e,name:"PolylineGraphics",description:"PolylineGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(le,{positions:Cesium.Cartesian3.fromDegreesArrayHeights([-75,45,5e5,-125,45,5e5]),width:4,material:new Cesium.PolylineDashMaterialProperty({color:Cesium.Color.CYAN})})})]})},x={render:e=>t.jsx(l.StrictMode,{children:t.jsxs(h,{full:!0,onMouseEnter:Q("mouseenter"),children:[t.jsx(s,{...e,name:"BillboardGraphics",description:"BillboardGraphics!!",position:Cesium.Cartesian3.fromDegrees(-40.0707383,40.7117244,100),selected:!0,children:t.jsx(Z,{image:"example.png",scale:.05})}),t.jsx(s,{...e,name:"BoxGraphics",description:"BoxGraphics!!",position:Cesium.Cartesian3.fromDegrees(.0707383,40.7117244,100),children:t.jsx(q,{material:Cesium.Color.RED,dimensions:new Cesium.Cartesian3(4e5,3e5,5e5)})}),t.jsx(s,{...e,name:"CorridorGraphics",description:"CorridorGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(J,{material:Cesium.Color.YELLOW,positions:Cesium.Cartesian3.fromDegreesArray([-100,40,-105,40,-105,35]),height:2e5,extrudedHeight:1e5,width:2e5,cornerType:Cesium.CornerType.BEVELED,outline:!0,outlineColor:Cesium.Color.WHITE})}),t.jsx(s,{...e,name:"CylinderGraphics",description:"CylinderGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,20.7117244,100),children:t.jsx(X,{length:4e5,topRadius:2e5,bottomRadius:2e5,material:Cesium.Color.GREEN.withAlpha(.5),outline:!0,outlineColor:Cesium.Color.DARKGREEN})}),t.jsx(s,{...e,name:"EllipseGraphics",description:"EllipseGraphics!!",position:Cesium.Cartesian3.fromDegrees(-34.0707383,60.7117244,100),children:t.jsx(ee,{material:Cesium.Color.RED,semiMinorAxis:15e4,semiMajorAxis:3e5,extrudedHeight:2e5,rotation:.78539,outline:!0})}),t.jsx(s,{...e,name:"EllipsoidGraphics",description:"EllipsoidGraphics!!",position:Cesium.Cartesian3.fromDegrees(-14.0707383,.7117244,100),children:t.jsx(ie,{material:Cesium.Color.BLUEVIOLET,radii:new Cesium.Cartesian3(3e5,3e5,3e5),fill:!0,outline:!0,outlineColor:new Cesium.Color(0,0,0,1)})}),t.jsx(s,{...e,name:"LabelGraphics",description:"LabelGraphics!!",position:Cesium.Cartesian3.fromDegrees(-34.0707383,5.7117244,100),children:t.jsx(te,{text:"LabelGraphics",font:"24px Helvetica",fillColor:Cesium.Color.SKYBLUE,outlineColor:Cesium.Color.BLACK,outlineWidth:2,style:Cesium.LabelStyle.FILL_AND_OUTLINE})}),t.jsx(s,{...e,name:"ModelGraphics",description:"ModelGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(re,{uri:"Cesium_Air.glb",minimumPixelSize:128,maximumScale:2e4})}),t.jsx(s,{...e,name:"PathGraphics",description:"PathGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(se,{material:Cesium.Color.RED,width:8,leadTime:10,trailTime:1e3,resolution:5})}),t.jsx(s,{...e,name:"PlaneGraphics",description:"PlaneGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,50.7117244,100),children:t.jsx(ne,{plane:new Cesium.Plane(Cesium.Cartesian3.UNIT_Z,0),dimensions:new Cesium.Cartesian2(4e5,3e5),fill:!1,outline:!0,outlineColor:Cesium.Color.YELLOW})}),t.jsx(s,{...e,name:"PointGraphics",description:"PointGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,60.7117244,100),children:t.jsx(oe,{color:Cesium.Color.BISQUE,pixelSize:10})}),t.jsx(s,{...e,name:"PolygonGraphics",description:"PolygonGraphics!!",children:t.jsx(ae,{hierarchy:Cesium.Cartesian3.fromDegreesArray([-108,42,-100,42,-104,40]),material:Cesium.Color.GREEN})}),t.jsx(s,{...e,name:"PolylineGraphics",description:"PolylineGraphics!!",position:Cesium.Cartesian3.fromDegrees(-74.0707383,40.7117244,100),children:t.jsx(le,{positions:Cesium.Cartesian3.fromDegreesArrayHeights([-75,45,5e5,-125,45,5e5]),width:4,material:new Cesium.PolylineDashMaterialProperty({color:Cesium.Color.CYAN})})})]})})};var j,B,A;y.parameters={...y.parameters,docs:{...(j=y.parameters)==null?void 0:j.docs,source:{originalSource:`{

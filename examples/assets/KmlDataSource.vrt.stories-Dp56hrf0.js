import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{n,t as r}from"./iframe-Crc4xRJp.js";import{n as i,t as a}from"./VrtViewer-Fxe_K7ud.js";import{n as o,t as s}from"./KmlDataSource-DMTAniZ0.js";var c,l,u,d,f,p;t((()=>{c=e(n(),1),i(),o(),l=r(),u={title:`VRT/KmlDataSource`,tags:[`vrt`],parameters:{layout:`fullscreen`,docs:{description:{component:"Stories tagged `vrt` are rendered deterministically (see `src/__vrt__`) so the\ntest runner can compare screenshots. Run `yarn storybook:build:vrt` then `yarn vrt`."}}}},d=URL.createObjectURL(new Blob([`<?xml version="1.0" encoding="UTF-8"?>
